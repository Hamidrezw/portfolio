...
const ContactMe = () => {
  return (
    <div className="py-10 md:py-20">
      ...
      <form className="font-ubuntu mt-12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 px-10 sm:px-0 container ">
        {["name", "email"].map((sub, i) => (
          <div className="flex flex-col gap-4.5 col-span-1" key={i}>
            ...
            <input
              ...
              className="pb-2 border-b-primary-light border-b w-full text-[16px] placeholder:text-[16px] text-white placeholder:text-white focus:outline-none"
            />
          </div>
        ))}
      ...
      <button
        type="submit"
        className="text-background bg-primary flex items-center justify-center gap-4 py-3 px-6 cursor-pointer rounded-4xl w-fit mx-auto mt-10 text-xl font-ubuntu"
      >
        Send Message
        <svg
          width="24"
