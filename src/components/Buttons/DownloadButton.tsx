const DownloadButton = () => {
  return (
    <a href="/files/resume.pdf" className="bg-white font-ubuntu mb-2 select-none cursor-pointer text-xl text-background rounded-full h-14 w-55 flex items-center justify-center gap-3">
      Download
      <svg
        width="24"
        height="24"
